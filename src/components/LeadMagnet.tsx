        ...
        <div className="lead-magnet-wrapper">
          ...
          <div className="lead-magnet-content">
            ...
            <p className="lead-magnet-description">
              Our free review helps you identify risks, coverage gaps, and smarter protection options tailored to your specific situation.
            </p>

            <div className="lead-magnet-includes">
              <h3 className="includes-title">Your Free Protection Review Includes</h3>
            ...
            <div className="lead-magnet-ctas">
              <button className="btn btn-primary btn-lg lead-magnet-primary-cta">
            ...
            <div className="visual-card">
              ...
              <div className="visual-card-body">
                <div className="visual-progress">
                  <div className="visual-progress-bar" style={{ width: '75%' }}></div>
                </div>
                <div className="visual-rows">
                  <div className="visual-row">
                    ...
                    <div className="visual-row-content">
                      <div className="visual-row-line" style={{ width: '80%' }}></div>
                      <div className="visual-row-line-short" style={{ width: '50%' }}></div>
                    </div>
                  </div>
                  <div className="visual-row">
                    ...
                    <div className="visual-row-content">
                      <div className="visual-row-line" style={{ width: '65%' }}></div>
                      <div className="visual-row-line-short" style={{ width: '40%' }}></div>
                    </div>
                  </div>
                  <div className="visual-row">
                    <div className="visual-row-icon visual-row-success">
                    ...
                    <div className="visual-row-content">
                      <div className="visual-row-line" style={{ width: '90%' }}></div>
                      <div className="visual-row-line-short" style={{ width: '60%' }}></div>
                    </div>
                  </div>
                </div>
